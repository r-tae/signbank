defmodule Signbank.Accounts do
  @moduledoc """
  ...
  def can_see_unpublished?(%Signbank.Accounts.User{role: role})
      when role in @admin_roles,
      do: true

  def can_see_unpublished?(_), do: false

  def can_edit?(%Signbank.Accounts.User{role: role})
      when role in @admin_roles,
      do: true
